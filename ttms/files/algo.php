...
class Teacher
{
    ...
    // Constructor to initialize the days property
    public function __construct()
    {
        // Initialize the days property as an empty array
        $this->days = array(
            array_fill(0, 6, array_fill(0, 5, null)), // For semester 1
            array_fill(0, 6, array_fill(0, 5, null))  // For semester 2
        );
    }
}
...
for ($I = 0; $I < 2 * $count; $I++) {
	...
	else if (isset($teachers[$tindex]->days[$sem % 2][$j][5]) || isset($teachers[$tindex2]->days[$sem % 2][$j][5]) || isset($teachers[$tindex3]->days[$sem % 2][$j][5])) 
	{
            continue;
        } else {

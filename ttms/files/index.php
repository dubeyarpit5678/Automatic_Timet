...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">TIME TABLE MANAGEMENT SYSTEM, Rajiv Gandhi Institute of Technology</h3>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Prof. Sunil Kachane</h3>
                    <hr/>
                    <h4 align="center">HOD<br/>Computer Engineering</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">PROF. Sanjay Bokade</h3>
                    <hr/>
                    <h4 align="center">Principle<br/> RGIT</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">PROF. Bhavesh Panchal </h3>
                    <hr/>
                    <h4 align="center">Cloud Computing <br/>Co-Ordinator</h4>
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <hr/>
            <div>
                <h4>Rajiv Gandhi Institute of Technology,
                </h4>
                <h4> Versova, Andheri</h4>
                <h4><strong>Call:</strong> 9807654321 </h4>
                <h4><strong>Email: </strong>rgit@mail.com</h4>
            </div>
